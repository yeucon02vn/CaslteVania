...
//void Game::DrawCamera(float x, float y, LPDIRECT3DTEXTURE9 texture, Camera *cam, int left, int top, int right, int bottom, int alpha)
//{
//	D3DXVECTOR3 p(x - cam->GetCameraPosition().x, y - cam->GetCameraPosition().y, 0);
//	RECT r;
//	r.left = left;
//	r.top = top;
//	r.right = right;
