...
bool GameObject::AABB(float obj_aleft, float obj_atop, float obj_aright, float obj_abottom,
						float obj_bleft, float obj_btop, float obj_bright, float obj_bbottom)
{
	float left = obj_bleft - obj_aright;
	float top = obj_btop - obj_abottom;
	float right = obj_bright - obj_aleft;
	float bottom = obj_bbottom - obj_atop;
